        ...
        <section class="md:w-1/2 md:flex md:flex-col md:border md:border-white/30 md:shadow-lg md:shadow-white/50 md:p-9">
            <section class="text-xl tracking-wide leading-relaxed py-5">
                <div class="py-4">
                    ...
                    @endif
                    <div>
                        <form action="{{ route('cust.profile.edit', ['customerName' => $customer->slug]) }}" method="POST">
                            @csrf
                            ...
                            <div class="flex justify-between">
                                <button type="submit"
                                    class="my-7 p-2 bg-orange-red w-full md:w-2/5 rounded font-bold text-2xl">Update Info</button>

                                <a href="{{ route('cust.info', ['customerName' => $customer->slug]) }}"
                                    class="my-7 p-2 border border-white w-full md:w-2/5 rounded font-bold text-2xl text-center hover:bg-orange-red/20 hover:border-orange-red/20">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
